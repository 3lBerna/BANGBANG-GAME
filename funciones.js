// INICIA EL JUEGO, MUESTRA TRANSICIÓN Y CAMBIA A PANTALLA DE PERSONAJE
function jugar() {
    ponerBG();
    setTimeout(function () {
        window.location.assign('personaje.html');
    }, 2000);
    var sfxStart = new Audio('sfx/Play.mp3');
    sfxStart.play();
}

// AÑADE FONDO NEGRO DE TRANSICIÓN
function ponerBG() {
...
// CAMBIA AL SIGUIENTE PERSONAJE EN LA SELECCIÓN
function siguientePersonaje() {
    ...
    var sfxclic = new Audio('sfx/clic.ogg');
    sfxclic.play();
}

// CAMBIA AL PERSONAJE ANTERIOR EN LA SELECCIÓN
...
// GUARDA PERSONAJE Y NOMBRE DEL JUGADOR 1 Y PASA A SELECCIÓN DEL JUGADOR 2
function personaje2() {
    ...
    var sfxStart = new Audio('sfx/p2.mp3');
    sfxStart.play();
}

// GUARDA PERSONAJE Y NOMBRE DEL JUGADOR 2 Y PASA AL JUEGO
...
// CARGA ESCENARIO, MARCADORES, GANADOR Y DATOS DE JUGADORES
function cargarEscenario() {
    ...
    // MOSTRAR CALAVERAS SEGÚN MUERTES
    ...
    // MOSTRAR PANTALLA DE GANADOR SI ALGUIEN LLEGA A 3
...
// CONTEO DE 3, 2, 1 CON EFECTO SONORO Y TIEMPO ALEATORIO
function conteo() {
    var sfxclic = new Audio('sfx/contador.wav');
...
function disparo1() {
    ...
    var sfxStart = new Audio('sfx/p1.mp3');
    sfxStart.play();
}
...
// REINICIA EL JUEGO Y VUELVE A SELECCIÓN DE PERSONAJE
function restart() {
    localStorage.setItem('marcador1', '0');
    localStorage.setItem('marcador2', '0');
    window.location.assign('personaje.html');
